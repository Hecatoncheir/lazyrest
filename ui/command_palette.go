...
func (application *Application) selectThemePreset(name string) {
	...
	application.Stream.ApplySettings(selected, application.config.Locale, application.config.Keybindings)
...
func (application *Application) reloadConfiguration() {
	...
	application.Stream.ApplySettings(settings.Theme, settings.Locale, settings.Keybindings)
